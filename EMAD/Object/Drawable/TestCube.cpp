...
TestCube::TestCube()
{
    ...
    mProgram = std::make_shared<Program>("Shader/test_vs.vert", "Shader/test_fs.frag");
    ...
    // 设置采样器对应的纹理单元
    mProgram->activate();
    mProgram->setInt("ourTexture1", 0);
    mProgram->setInt("ourTexture2", 1);
}

void TestCube::draw(glm::mat4 view, glm::mat4 projection)
{
    mProgram->activate();
