...
GPUShader::GPUShader(ShaderType sType, const std::string& shaderCode){
	const char* shaderCodeCStyle = shaderCode.c_str();

	std::cout << shaderCodeCStyle << std::endl;
...
GPUShader::GPUShader(ShaderType sType, const std::string& dir, const std::string& sName){
		mShaderType = sType;
